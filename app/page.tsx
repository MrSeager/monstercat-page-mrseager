...
export default function Home() {
  ...
  return (
    <div className="select-none relative flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <BackgroundImage />
      <HeaderNavbar />
      <main className="z-10 flex min-h-screen w-full max-w-[120rem] flex-col items-center justify-between py-32 px-16 bg-transparent sm:items-start">
        <div className="flex justify-start px-15 w-full gap-15">
          ...
          <div className="flex flex-col justify-center gap-3">
            <h1 className="font-bold text-[90px] -my-4 text-transparent [-webkit-text-stroke:2px_white]">Arcane</h1>
            <h2 className="font-semibold text-[50px] -my-4">Soundtrack</h2>
